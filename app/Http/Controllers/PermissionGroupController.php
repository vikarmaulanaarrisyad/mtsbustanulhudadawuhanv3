    ...
    public function data()
    {
        ...
        return datatables($query)
            ...
            ->addColumn('action', function ($query) {
                ...
                if (Auth::user()->hasPermissionTo('permission-group.edit')) {
                ...
                if (Auth::user()->hasPermissionTo('permission-group.show')) {
                ...
                if (Auth::user()->hasPermissionTo('permission-group.delete')) {
