...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <x-card>
                <x-slot name="header">
                    <button onclick="addForm(`{{ route('quotes.index') }}`)" class="btn btn-sm btn-info"><i
...
@push('scripts')
    <script>
        ...
        $('#deleteSelectedBtn').on('click', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: '{{ route('quotes.deleteSelected') }}', // Route untuk delete massal, sesuaikan
                        type: 'POST',
                        data: {
                            _token: '{{ csrf_token() }}',
                            ids: selectedIds,
        ...
        function addForm(url, title = 'Kutipan') {
            $(modal).modal('show');
        ...
        function editForm(url, title = 'Kutipan') {
            Swal.fire({
                title: "Memuat...",
