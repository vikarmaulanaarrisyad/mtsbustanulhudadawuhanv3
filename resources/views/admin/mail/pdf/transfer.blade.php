    ...
    <div class="content">
        ...
        <table style="width: 100%; margin-left: 30px; margin-bottom: 20px;">
            <tr>
                ...
                <td width="2%">:</td>
                <td><strong>{{ $transfer->student->nama_lengkap }}</strong></td>
            </tr>
            <tr>
                <td>NISN / NIK</td>
                <td>:</td>
                <td>{{ $transfer->student->nisn ?? '-' }} / {{ $transfer->student->nik ?? '-' }}</td>
            </tr>
            <tr>
                <td>Tempat, Tgl Lahir</td>
                <td>:</td>
                <td>{{ $transfer->student->tempat_lahir }},
                    {{ \Carbon\Carbon::parse($transfer->student->tanggal_lahir)->translatedFormat('d F Y') }}</td>
            </tr>
            <tr>
                <td>Jenis Kelamin</td>
                <td>:</td>
                <td>{{ $transfer->student->jenis_kelamin == 'L' ? 'Laki-laki' : 'Perempuan' }}</td>
            </tr>
            <tr>
                <td>Kelas Terakhir</td>
                <td>:</td>
                <td>{{ $transfer->student->kelas_lengkap }}</td>
            </tr>
        </table>
        ...
        <table style="width: 100%; margin-left: 30px; margin-bottom: 20px;">
            <tr>
                ...
                <td width="2%">:</td>
                <td>{{ $transfer->student->parents->father_name ?? ($transfer->student->parents->mother_name ?? '-') }}</td>
            </tr>
            <tr>
                <td>Alamat</td>
                <td>:</td>
                <td>{{ $transfer->student->alamat ?? '-' }}</td>
            </tr>
        </table>
        ...
        <table style="width: 100%; margin-left: 30px; margin-bottom: 20px;">
            <tr>
                ...
                <td width="2%">:</td>
                <td><strong>{{ $transfer->destination_school }}</strong></td>
            </tr>
            <tr>
                <td>Alasan Pindah</td>
                <td>:</td>
        ...
        <p>Bersama ini kami lampirkan dokumen pendukung (Buku Rapor) yang bersangkutan. Demikian surat keterangan ini dibuat
