        ...
        <x-card>
            <x-slot name="header">
                <div class="d-flex justify-content-between align-items-center">
                    <h3 class="card-title"><i class="fas fa-truck-moving mr-1"></i> Daftar Mutasi Keluar</h3>
                    <button onclick="addForm(`{{ route('student-transfers.store') }}`)" class="btn btn-sm btn-primary">
                        <i class="fas fa-plus-circle"></i> Buat Surat Mutasi
                    </button>
                </div>
            </x-slot>
...
<x-modal size="modal-lg" data-backdrop="static">
    <x-slot name="title">Form Surat Mutasi</x-slot>
    ...
    <div class="form-group">
        ...
        <input type="text" name="destination_school" class="form-control" placeholder="Contoh: SMP Negeri 1 Situbondo">
    </div>
    <div class="form-group">
        <label>Alasan Pindah</label>
        <textarea name="reason" class="form-control" rows="2" placeholder="Contoh: Mengikuti orang tua pindah domisili"></textarea>
    </div>
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
...
<script>
    ...
    $(function() {
        table = $('.table').DataTable({
            ...
            ajax: { url: '{{ route("student-transfers.data") }}' },
            columns: [
