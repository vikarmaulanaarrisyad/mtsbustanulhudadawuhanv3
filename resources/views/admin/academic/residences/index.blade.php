...
@section('content')
        ...
        <div class="col-lg-12 col-md-12 col-12">
            <x-card>
                @can('class-group.create')
                    <x-slot name="header">
                        <button onclick="addForm(`{{ route('residences.store') }}`)" class="btn btn-sm btn-info"><i
    ...
    @include('admin.academic.residences.form')
    @include('admin.academic.residences.import-excel')
@endsection
...
@push('scripts')
    <script>
        ...
        function addForm(url, title = 'Form Tempat Tinggal') {
            $(modal).modal('show');
        ...
        function editForm(url, title = 'Form Tempat Tinggal') {
            Swal.fire({
                title: "Memuat...",
