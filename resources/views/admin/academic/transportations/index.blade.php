...
@section('title', 'Mode Transportasi')
...
@section('content')
        ...
        <div class="col-lg-12 col-md-12 col-12">
            <x-card>
                @can('class-group.create')
                    <x-slot name="header">
                        <button onclick="addForm(`{{ route('transportations.store') }}`)" class="btn btn-sm btn-info"><i
    ...
    @include('admin.academic.transportations.form')
    @include('admin.academic.transportations.import-excel')
@endsection
...
@push('scripts')
    <script>
        ...
        function addForm(url, title = 'Form Transportasi') {
            $(modal).modal('show');
        ...
        function editForm(url, title = 'Form Transportasi') {
            Swal.fire({
                title: "Memuat...",
