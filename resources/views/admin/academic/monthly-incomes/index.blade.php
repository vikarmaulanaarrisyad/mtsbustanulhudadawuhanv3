...
@section('title', 'Penghasilan Bulanan')
...
@section('content')
        ...
        <div class="col-lg-12 col-md-12 col-12">
            <x-card>
                @can('class-group.create')
                    <x-slot name="header">
                        <button onclick="addForm(`{{ route('monthly-incomes.store') }}`)" class="btn btn-sm btn-info"><i
    ...
    @include('admin.academic.monthly-incomes.form')
    @include('admin.academic.monthly-incomes.import-excel')
@endsection
...
@push('scripts')
    <script>
        ...
        table = $('.table').DataTable({
            ...
            responsive: true,
            ajax: {
                url: '{{ route('monthly-incomes.data') }}',
            },
            columns: [{
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex',
        ...
        function addForm(url, title = 'Form Penghasilan Bulanan') {
            $(modal).modal('show');
        ...
        function editForm(url, title = 'Form Penghasilan Bulanan') {
            Swal.fire({
                title: "Memuat...",
