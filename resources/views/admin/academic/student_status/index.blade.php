        ...
        <div class="col-lg-12 col-md-12 col-12">
            <x-card>
                @can('class-group.create')
                    <x-slot name="header">
                        <button onclick="addForm(`{{ route('student-status.store') }}`)" class="btn btn-sm btn-info"><i
...
@push('scripts')
    <script>
        ...
        function addForm(url, title = 'Form Status Peserta Didik') {
            $(modal).modal('show');
        ...
        function editForm(url, title = 'Form Status Peserta Didik') {
            Swal.fire({
                title: "Memuat...",
