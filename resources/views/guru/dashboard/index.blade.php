    ...
    <div class="relative z-10">
        <div class="flex justify-between items-start mb-8">
            ...
            <div class="flex items-center space-x-3">
                <a href="{{ route('guru.announcements') }}" class="relative w-12 h-12 bg-white/10 rounded-2xl border border-white/20 text-white flex items-center justify-center transition-all active:scale-90 hover:bg-white/20">
...
<div class="px-6 -mt-12 mb-32 relative z-20">
                    ...
                    <div class="carousel-item {{ $index == 0 ? 'active' : '' }}">
                        <div class="stu-banner-item" style="background: linear-gradient(135deg, {{ $index % 2 == 0 ? '#065f46, #10b981' : '#1e3a8a, #3b82f6' }});">
                            <div class="relative z-10">
                                ...
                                <a href="{{ route('guru.announcements') }}" class="stu-banner-btn mt-6 inline-block bg-white text-emerald-700 px-6 py-2.5 rounded-xl font-black text-[10px] uppercase tracking-wider shadow-lg hover:bg-emerald-50 transition-all">
                                    Baca Selengkapnya
                                </a>
                            </div>
    ...
    <div class="bg-white rounded-[2.5rem] p-8 shadow-sm border border-slate-50 mb-10">
        ...
        <div class="grid grid-cols-4 gap-4 text-center">
            ...
            {{-- Informasi --}}
            <div class="mb-4">
                <a href="{{ route('guru.announcements') }}" class="stu-quick-link">
    ...
    function submitPoint() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: '{{ route("guru.behavior-logs.store") }}',
                    method: 'POST',
                    data: form.serialize(),
                    success: function(response) {
                        Swal.fire({ icon: 'success', title: 'BERHASIL', text: response.message, showConfirmButton: false, timer: 2000 }).then(() => { 
